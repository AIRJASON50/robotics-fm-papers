...
- **Llama 5**: Meta announcement, 2026.04.08 (**no paper**; 600B+ dense, 5M context, System 2 Thinking + RSI, 500K Blackwell B200 训练)
...
2025.04  Qwen3
2026.04.08  *** Llama 5 (Meta, 600B dense, 5M context, RSI) ***  <- 回到 dense, 加 reasoning
```
...
- **2026.04 Llama 5**: Meta **回退到 dense (600B+)**, 5M context, 首次加入 System 2 Thinking + Recursive Self-Improvement (RSI), 500K Blackwell B200 集群训练。详见 `26_Llama5/llama5_notes.md`。
