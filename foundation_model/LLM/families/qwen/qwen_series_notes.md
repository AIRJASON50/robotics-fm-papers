...
|------|-------------|--------------|-----------------|--------------|----------------|
| 注意力 | MHA / GQA (72B) | 全面 GQA | GQA | GQA + QK-Norm | **混合注意力** |
| 位置编码 | RoPE 10K | RoPE 1M + QKV-bias | RoPE 1M + QKV-bias | RoPE (去 QKV-bias) | RoPE + Gated Delta |
| 激活 | SwiGLU | SwiGLU | SwiGLU | SwiGLU | SwiGLU |
| MoE | 无 | 57B-A14B | Turbo 系列 | 128 experts / 8 active | 进一步优化 |
...
| 版本 | 总参 | 激活参 | 专家数 | 每 token 激活 | 共享专家 |
|------|------|--------|--------|-------------|---------|
| Qwen2-MoE | 57B | 14B | 64 | 8 | 有 |
| Qwen3-MoE | 235B | 22B | 128 | 8 | **无** (去掉了) |
| Qwen3.5 | 397B | 17B | 未公开 | 未公开 | 未公开 |

Qwen3 去掉共享专家 (shared expert) 的理由: 使用 global-batch load balancing loss 促进专家专精化, 每个专家负责更窄的领域, 比 "一个共享专家兜底" 更高效。这与 Kimi K2 (保留 1 个共享专家) 形成有趣对比。
