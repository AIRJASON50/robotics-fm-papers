...
| 家族 | 笔记位置 | 与 GPT 的关系 |
|------|---------|-------------|
| Kimi | `../kimi/kimi_series_notes.md` | 借鉴 DeepSeek MLA+MoE, Muon 优化器是新贡献 |
| Qwen | `../qwen/qwen_series_notes.md` | 中国的 Llama, 数据飞轮 3T→36T |
| DeepSeek | `../deepseek/deepseek_series_notes.md` | MLA 架构创新, GRPO 简化 RLHF |
| Llama | `../llama/llama_series_notes.md` | 开源策略定义者, OpenVLA 用 Llama 做 backbone |
| Google RT | `../../robotics/families/Google_RT_Series/RT_family_notes.md` | RT-2 = GPT 的 VLA 化, SayCan = GPT 做 robot planner |
| PI | `../../robotics/families/pi_Series/pi_family_notes.md` | pi_0 = RT-2 精神续作, Flow Matching 替代离散 token |
| GR00T | `../../robotics/families/GR00T_Series/GR00T_family_notes.md` | GR00T N1.5 也用 Flow Matching, 和 pi_0 殊途同归 |
